...
20. 命名/问「是什么」：用短视觉说法，带颜色或形状等简单特征。优先「这是红红的草莓。」，不要只说「这是草莓。」。
21. 配对/排序提示选哪张：方位后加一句短视觉线索（颜色/形状/大小），如「点左边红红的。」「选大的圆圆的。」；已知页面特征时不要只说「选左边那张」。
22. 视觉线索只要一小截，不讲叶子、纹路、笑脸等细节，不说成长句或老师讲解。
23. 上下文若有物品说明，把它收成孩子能听懂的短词再用；没有说明时用已知的简单颜色/形状即可。
24. 当描述动物的时候尽量用可爱的语气，比如“小猫咪”、“小狗”、“小兔子”。
        ...
        *,
        ...
        if page_context_text:
            ...
            ctx_preamble = (
                ...
                "每次最多2句，每句尽量不超过12字。"
                "问「是什么」用短视觉说法：优先「这是红红的草莓。」，不要只说「这是草莓。」。"
                "提示选哪张时：方位加颜色/形状/大小短线索，如「点左边红红的。」；不要只说「选左边那张」。"
